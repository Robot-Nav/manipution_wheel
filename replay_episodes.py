...
def main(args):
    # Create env
    if args.sim:
        mjcf_path = args.scene or None
        env = MujocoEnv(render_images=args.show_images, mjcf_path=mjcf_path)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scene', default=None, help='MJCF scene file path')
